...
namespace PLM_Lynx._03_GUI_User_Interface._3_7_Purchase_version_Hue
{
    public partial class frmMake_New_PO_V2 : Form
    {
        ...
        // 1.1 Các table dữ liêu chung

        /// <summary>
        /// Return ( CurrencyID, CurrencyName, CurrencyRate )
        /// </summary>
        ...
        /// <summary>
        /// return ( SupplierID , SupplierCode, SupplierName, SupplierLocation, SupplierPhone, SupplierTaxNumber, SupplierNote, SupplierContactPerson )
        /// </summary>
        private DataTable tblPur_Supplier = new DataTable();

        /// <summary>
        /// return ( TaxID, TaxName, TaxValue )
        /// </summary>
        private DataTable tblPur_Tax = new DataTable();

        /// <summary>
        /// return ( UnitID, UnitName, UnitValue, UnitContent )
        /// </summary>
        ...
        /// <summary>
        /// return table  ( PartCode, PartName, Quantity, UnitPrice, Unit, Discount, Total, TaxCode )
        /// </summary>
        private DataTable tblPur_Content = new DataTable();

        public string _UserName { get; set; }

        #endregion ===== 1. FORM CONSTRUCTORS ========

        //=========================================================
        //=========================================================
        //=========================================================

        #region ===== 2. FORM EVENTS  ========
        ...
        #endregion ===== 2. FORM EVENTS  ========

        //=========================================================
        //=========================================================
        //=========================================================

        #region ===== 3. BUSINESS LOGIC ========
        ...
        /// <summary>
        /// Method : Kiểm tra dữ liệu trong bảng tblPur_Content
        /// </summary>
        /// <returns></returns>
        private bool Check_tblPur_Content()
        {
            // Nội dung kiểm tra
            // 1. Bảng có dữ liệu hay không  ?
            // 2. Kiểm tra có PartCode trùng lặp hay không         ?
            // 3. Kiểm tra PartCode và PartName có rỗng hay không ?
            // 4. Kiểm tra Quantity có lớn hơn 0 hay không ?
            // 5. Kiểm tra UnitPrice có lớn hơn 0 hay không ?
            ...
            else
            {
                foreach (DataRow row in tblPur_Content.Rows)
                {
                    ...
                    // 4. Kiểm tra Quantity và UnitPrice có lớn hơn 0 hay không ?
        ...
        private void cms_dgv_List_Content_Change_Unit_Click(object sender, EventArgs e)
        {
            using (frm_Choose_Unit frm = new frm_Choose_Unit())
            {
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Unit updated for selected rows.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
